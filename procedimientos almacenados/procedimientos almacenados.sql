...
1. Crear un procedimiento almacenado en el esquema HumanResources que dada una determinada inicial, devuelva codigo,
nombre, apellido y dirección de correo de los empleados cuyo nombre coincida con la inicial ingresada.
...
2. Crear un procedimiento almacenado llamado ProductoVendido que permita ingresar un producto como parámetro,
si el producto ha sido vendido imprimir el mensaje “El PRODUCTO HA SIDO VENDIDO” de lo contrario imprimir
...
3. Crear un procedimiento almacenado en el esquema dbo para la actualización de precios llamado ActualizaPrecio
...
4. Crear un procedimiento almacenado llamado ProveedorProducto que devuelva los proveedores,
el nombre del producto y el número de cuenta, y el código de unidad de medida que proporciona el
producto especificado por parámetro.
...
nombre, apellido y sector del empleado que le pasemos como argumento. No es necesario pasar 
elnombre y apellido exactos al procedimiento.
...
exec BuscarEmpleados @inicial = g
