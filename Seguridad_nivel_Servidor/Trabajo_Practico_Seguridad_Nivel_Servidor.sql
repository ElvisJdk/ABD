...
SELECT
    ...
    sl.is_policy_checked AS CheckPolicy,
    sl.is_expiration_checked AS CheckExpiration,
    sp.create_date AS FechaCreacion
FROM sys.server_principals sp
LEFT JOIN sys.sql_logins sl
    ON sp.principal_id = sl.principal_id
WHERE sp.name IN ('AnaGarcia', 'CarlosRodriguez', 'LauraMartinez')
ORDER BY sp.name;
GO
